 ...
 * <p>Made this is a singleton class to avoid creating multiple instances of the class.
 ...
 * even though it might not be the most ideal situation.</p>
 */
public class ChaosGameDialogHandler {
  ...
  /**
   * Method for creating a dialog for the user to choose a color.
   *
